    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(upload_to='static/images/banner', verbose_name='轮播图')),
                ('img_url', models.URLField(max_length=100, verbose_name='图片链接')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=50, verbose_name='标题')),
                ('link', models.URLField(default='', max_length=100, verbose_name='链接')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(default=None, upload_to='static/images/post', verbose_name='博客封面')),
                ('views_num', models.IntegerField(default=0, verbose_name='浏览量')),
                ('is_recommend', models.BooleanField(default=False, verbose_name='是否推荐博客')),
                ('category', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='blogapp.BlogCategory', verbose_name='博客分类')),
            ],
            options={
